const NavBar: React.FC = () => {
      ...
      <div className="w-full px-6 py-5 bg-cyan-700 justify-between items-center inline-flex">
        ...
        <div className="justify-start items-center gap-6 flex">
          <div className="w-8 h-8 relative">
            ...
            <svg width="32" height="32" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#ffffff" stroke-width="1" stroke-linecap="round" stroke-linejoin="miter"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="1.9200000000000004"><polyline points="2 3 5 3 8.5 16 18 16 21 7 6.1 7" stroke-linecap="round"></polyline><line x1="9.99" y1="20" x2="10.01" y2="20" stroke-linecap="round" stroke-width="2"></line><line x1="15.99" y1="20" x2="16.01" y2="20" stroke-linecap="round" stroke-width="2"></line></g><g id="SVGRepo_iconCarrier"><polyline points="2 3 5 3 8.5 16 18 16 21 7 6.1 7" stroke-linecap="round"></polyline><line x1="9.99" y1="20" x2="10.01" y2="20" stroke-linecap="round" stroke-width="2"></line><line x1="15.99" y1="20" x2="16.01" y2="20" stroke-linecap="round" stroke-width="2"></line></g></svg>
          </div>
          <div className="w-8 h-8 relative">
            <svg
              xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="justify-center items-center gap-6 flex">
          <div className="w-[154px] h-12 justify-center items-center flex">
            <div className="px-6 py-3.5 bg-gray-100 rounded-sm justify-center items-center gap-2 inline-flex">
              ...
              <div className="w-4 h-4 relative"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 16 16" fill="none">
  ...
  <path d="M12.1875 7.875C12.1875 8.08211 12.0196 8.25 11.8125 8.25C11.6054 8.25 11.4375 8.08211 11.4375 7.875C11.4375 7.66789 11.6054 7.5 11.8125 7.5C12.0196 7.5 12.1875 7.66789 12.1875 7.875Z" fill="#191C1F" stroke="#5F6C72" stroke-width="1.5"/>
</svg></div>
            <div className="text-gray-500 text-sm font-normal font-ps leading-tight">
              Need Help
            </div>
        ...
        <div className="justify-center items-center gap-2 flex">
          <div className="w-7 h-7 relative"><svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 28 28" fill="none">
