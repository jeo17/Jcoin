            ...
            <div className="justify-start items-start gap-3 flex">
              ...
              <div className="w-4 h-4 relative">
                <svg
                  ...
                  fill="none"
                >
                  <g clip-path="url(#clip0_2506_3527)">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
              ...
              <div className="w-4 h-4 relative">
                <svg
                  ...
                  fill="none"
                >
                  <g clip-path="url(#clip0_2506_3530)">
                    <path
              ...
              <div className="w-4 h-4 relative">
                <svg
                  ...
                  fill="none"
                >
                  <g clip-path="url(#clip0_2506_3532)">
                    <path
              ...
              <div className="w-4 h-4 relative">
                <svg
                  ...
                  fill="none"
                >
                  <g clip-path="url(#clip0_2506_3538)">
                    <path
      ...
      <div className="w-full px-6 py-4 bg-white shadow-inner justify-between items-center inline-flex border-b border-[#E4E7E9]">
        <div className="justify-center items-center flex">
          ...
          <div className="justify-start items-center gap-1.5 flex px-4 py-3.5 hover:bg-gray-100 cursor-pointer">
            ...
            <div className="text-gray-500 text-sm font-normal font-ps leading-tight">
              Track Order
            </div>
          </div>
          <div className="justify-start items-center gap-1.5 flex px-4 py-3.5 hover:bg-gray-100 cursor-pointer">
