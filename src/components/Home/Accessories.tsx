...
import { AccessoriesHeader } from "../../assets/data/AccessoriesData";
import banner1 from "../../assets/productes/Image2.png";
import { useGetMyAccessoriesQuery } from "../../Redux/dataApi";
    ...
    return (
      <div className="flex flex-row-reverse gap-[24px]">
        ...
        <div className="flex flex-col gap-[24px] flex-grow w-[76%]">
          ...
          <main className="flex lg:gap-[12px] xl:gap-[16px] gap-[12px] flex-wrap">
            {data.map((Accessorie,index) => {
              return (
                  ...
                  <div className="relative group">
                    ...
                    <div className="flex gap-[8px] items-center justify-center hover:cursor-pointer absolute inset-0 bg-black opacity-0 bg-opacity-0 group-hover:bg-opacity-20 transition duration-300 ease-in-out hover:opacity-100">
                      <span
                        ...
                        onClick={() => {
                          isProductInWishlist(Accessorie.id)
                            ? (removeProductFromWishlist(Accessorie.id),
                              showSnackbar("Product removed from wishlist"))
                            : (addProductToWishlist(Accessorie),
                      ...
                      <span
                        className="bg-white rounded-[50%] w-[48px] h-[48px] flex justify-center items-center hover:scale-105"
                        onClick={() => {
                          addProductToCard({ ...Accessorie, quantity: 1 });
