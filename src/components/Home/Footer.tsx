...
const Footer = () => {
    ...
    <div className="flex py-[72px] pl-[1.5%] items-start gap-[24px] bg-[#191C1F]">
      ...
      <div className="flex flex-col items-start gap-[12px] w-[16%]">
        <div className="flex flex-col items-start gap-[18px]">
          ...
          <div className="flex flex-col items-start gap-[12px]">
            {TopCategory.categories.map((category) => {
              return (
                <span className="text-[#929FA5] text-[14px] leading-[20px]">
                  {category}
                </span>
              );
            })}
        ...
        <div className="flex flex-col items-start gap-[12px]">
          ...
          <div className="flex flex-col items-start gap-[12px]">
            {TopCategory.Accessories.map((accessorie) => {
              return (
                <span className="text-[#929FA5] text-[14px] leading-[20px]">
                  {accessorie}
                </span>
  ...
  <g clip-path="url(#clip0_2503_13933)">
  ...
  <defs>
    <clipPath id="clip0_2503_13933">
      <rect width="32" height="32" fill="white" transform="translate(0 0.5)"/>
           ...
           <div className="flex py-[16px] px-[20px] items-center justify-center gap-[16px] bg-[#303639] rounded-[3px]">
           <svg xmlns="http://www.w3.org/2000/svg" width="32" height="33" viewBox="0 0 32 33" fill="none">
  <g clip-path="url(#clip0_2503_13940)">
        ...
        <div className="flex items-start gap-[8px] flex-wrap">
           {
            Tags.items.map((tag) => {
                return(
                    <span className="px-[12px] py-[6px] rounded-[2px] border border-[#303639] text-white text-[14px] leading-[20px]">{tag}</span>
                )
            })
           }
        </div>
